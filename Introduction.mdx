...
description: A comprehensive test of all MDX components available in DocumentationAI
---

# Complete MDX Components Test Suite
...
2. [Callout Components](#callout-components)
3. [Code Examples](#code-examples)
4. [Tables and Data](#tables-and-data)
5. [Advanced Layouts](#advanced-layouts)
...
<CodeGroup uid="api-examples-001" show-lines="true">
  ```typescript
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 20px 0;">
  <div>
    <h4>Left Column</h4>
    <p>This demonstrates how you can create multi-column layouts within MDX. This is particularly useful for:</p>
    <ul>
      <li>Comparing options side by side</li>
      <li>Showing before/after examples</li>
      <li>Creating responsive layouts</li>
    </ul>
  </div>
  <div>
    <h4>Right Column</h4>
    <p>The right column can contain different content types, including code:</p>
...
<div style="border-radius: 8px; padding: 20px; margin: 20px 0;">
  <h3 style="margin-top: 0;">POST /api/documents</h3>
  
  <p>Create a new documentation page.</p>
  
  <h4>Request Body</h4>
  
  <CodeGroup uid="api-request-body" show-lines="false">
    ```json
    {
  ...
  <Callout uid="api-auth-note" kind="note" collapsed="false">
    **Authentication Required:** This endpoint requires a valid API key to be passed in the `Authorization` header.
  </Callout>
</div>
...
<details>
  ...
  These options provide fine-grained control over the documentation system:
...
<Callout uid="deployment-note" kind="warning" collapsed="false">
  ...
  See our [deployment guide](/guides/deployment) for detailed instructions.
</Callout>
...
<Image
  uid="conclusion-image"
  src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&h=600&fit=crop"
  width="1200"
  height="600"
  alt="Team collaboration"
  style="width: 100%; max-width: 800px; height: auto; margin: 20px auto; display: block; border-radius: 8px;"
/>
